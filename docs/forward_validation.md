...
this target. The method is also evaluated across the original and replan GTVs.
Residual differences remain visible; native agreement is assessed separately
from preservation of the source geometry. The direct comparison with coarse
CT-plane sampling is the main explanatory figure in the README.
